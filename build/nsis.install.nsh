Name "gstle ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/saintligne/go-saintlignediuma/issues"
!define UPDATEURL "https://github.com/saintligne/go-saintlignediuma/releases"
!define ABOUTURL "https://github.com/saintligne/go-saintlignediuma#ethereum-go"
...
# Install gstle binary
Section "Gstle" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gstle}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gstle.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gstle.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gstle incoming peers (TCP:30410)"
  SimpleFC::AdvRemoveRule "Gstle outgoing peers (TCP:30410)"
  SimpleFC::AdvRemoveRule "Gstle UDP discovery (UDP:30410)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gstle incoming peers (TCP:30410)" ""  6 1 1 2147483647 1 "$INSTDIR\gstle.exe" "" "" "Ethereum" 30410 "" "" ""
  SimpleFC::AdvAddRule "Gstle outgoing peers (TCP:30410)" ""  6 2 1 2147483647 1 "$INSTDIR\gstle.exe" "" "" "Ethereum" "" 30410 "" ""
  SimpleFC::AdvAddRule "Gstle UDP discovery (UDP:30410)" "" 17 2 1 2147483647 1 "$INSTDIR\gstle.exe" "" "" "Ethereum" "" 30410 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gstle.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gstle.ipc"
