...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gstle.ipc", false, filepath.Join(os.TempDir(), "gstle.ipc")},
		{"data", "gstle.ipc", false, "data/gstle.ipc"},
		{"data", "./gstle.ipc", false, "./gstle.ipc"},
		{"data", "/gstle.ipc", false, "/gstle.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gstle.ipc", true, `\\.\pipe\gstle.ipc`},
		{"data", "gstle.ipc", true, `\\.\pipe\gstle.ipc`},
		{"data", `\\.\pipe\gstle.ipc`, true, `\\.\pipe\gstle.ipc`},
	}
